...
<spring:bind path="jbdTravelPointLog2013.*">
...
<form:form commandName="jbdTravelPointLog2013" method="post" action="editJbdTravelPointLog2013.html" onsubmit="if(isFormPosted()){return true;}{return false;}" id="jbdTravelPointLogForm">
...
<form:hidden path="logId"/>
    ...
    <td align="left">
        <jecs:list listCode="fibankbooktemp.dealtype" name="dealType" id="dealType" value="${jbdTravelPointLog2013.dealType}" defaultValue="A"/>
    </td></tr>
