...
<spring:bind path="jbdTravelPointLog2012.*">
...
<form:form commandName="jbdTravelPointLog2012" method="post" action="editJbdTravelPointLog2012.html" onsubmit="if(isFormPosted()){return true;}{return false;}" id="jbdTravelPointLogForm">
...
<form:hidden path="logId"/>
    ...
    <td align="left">
        <jecs:list listCode="fibankbooktemp.dealtype" name="dealType" id="dealType" value="${jbdTravelPointLog2012.dealType}" defaultValue="A"/>
    </td></tr>
