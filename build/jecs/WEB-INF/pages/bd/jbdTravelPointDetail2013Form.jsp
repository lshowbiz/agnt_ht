...
<spring:bind path="jbdTravelPointDetail2013.*">
...
<form:form commandName="jbdTravelPointDetail2013" method="post" action="editJbdTravelPointDetail2013.html"  onsubmit="if(isFormPosted()){return true;}{return false;}" id="jbdTravelPointDetailForm">
...
<form:hidden path="id"/>
    ...
    <td align="left">
	  <jecs:list name="travelType" id="travelType" listCode="bd.traveltype.2013" value="${jbdTravelPointDetail2013.travelType}" defaultValue="" showBlankLine="true"/>
