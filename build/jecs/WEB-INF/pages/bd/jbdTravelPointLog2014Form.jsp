...
<spring:bind path="jbdTravelPointLog2014.*">
...
<form:form commandName="jbdTravelPointLog2014" method="post" action="editJbdTravelPointLog2014.html" onsubmit="if(isFormPosted()){return true;}{return false;}" id="jbdTravelPointLogForm">
...
<form:hidden path="logId"/>
    ...
    <td align="left">
        <jecs:list listCode="fibankbooktemp.dealtype" name="dealType" id="dealType" value="${jbdTravelPointLog2014.dealType}" defaultValue="A"/>
    </td></tr>
