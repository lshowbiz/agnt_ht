...
<c:if test='${empty jpoMemberOrder.moId}'>
	...
	onclick="window.location.href='editJpoMemberROrderLC.html?strAction=addPoMemberROrderLC'" 
	value="兰超" />
</c:if>
</jecs:power>
...
<jecs:power powerCode="deletePoMemberROrder">
	<input data-inline="true" type="submit" class="button" name="delete" onclick="bCancel=true;return confirmDelete(this.form,'PoMemberROrder')" value="<jecs:locale key="operation.button.delete"/>" />
</jecs:power>
</c:if>
