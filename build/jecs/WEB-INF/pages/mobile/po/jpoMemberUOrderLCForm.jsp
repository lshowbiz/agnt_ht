...
<jecs:power powerCode="deletePoMemberUOrderLC">
	<input data-inline="true" type="submit" class="button" name="delete" onclick="bCancel=true;return confirmDelete(this.form,'PoMemberUOrderLC')" value="<jecs:locale key="operation.button.delete"/>" />
</jecs:power>
</c:if>
...
<c:if test="${sessionLogin.userType=='M' }">
	...
	<div class="searchBar">
		...
		<input data-inline="true" type="button" class="button" name="back"  onclick="window.location.href='jpoMemberUOrders.html?needReload=1'" value="<jecs:locale key="operation.button.return"/>" />
	</div>
</div>
<script>
function stepBack1(){
