...
<jecs:power powerCode="addPoMemberSFOrderLC">
...
<jecs:power powerCode="editPoMemberSFOrderLC">
				<input data-inline="true" type="submit" class="button" name="save"  onclick="return nextSave();" value="<jecs:locale key="operation.button.save"/>" />
</jecs:power>
<jecs:power powerCode="deletePoMemberSFOrderLC">
				<input data-inline="true" type="submit" class="button" name="delete" onclick="bCancel=true;return confirmDelete(this.form,'PoMemberSFOrderLC')" value="<jecs:locale key="operation.button.delete"/>" />
</jecs:power>
</c:if>
...
<form:form commandName="jpoMemberOrder" method="post" action="editJpoMemberSFOrderLC.html" id="jpoMemberOrderForm">
...
<c:if test='${param.strAction=="editPoMemberSFOrderLC"}'>
    <tr><th>
    ...
    <td align="left">
    	...
    	<c:if test='${param.strAction=="addPoMemberSFOrderLC"}'>
...
<c:if test="${sessionLogin.userType=='M' }">
	...
	<div class="searchBar">
		...
		<input data-inline="true" type="button" class="button" name="back"  onclick="window.location.href='jpoMemberSFOrders.html?needReload=1'" value="<jecs:locale key="operation.button.return"/>" />
	</div>
</div>
<script>
function stepBack1(){
...
<%-- <c:if test="${varStatus.count % 2 == 1  }"></c:if> --%>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>

    <td><br />
    	<jecs:code listCode="pmproduct.productcategory" value="${jpms.key }"/>,<jecs:label key="pd.price"/>${jpms.value.productInfo.storeFpPrice },<jecs:label key="busi.direct.pv"/>${jpms.value.productInfo.storeFpPv }<br />
		<br />
				...
				<tr>
					...
					<c:forEach items="${jpms.value.size }" var="size">
						...
						<c:if test="${not empty jpms.value.jpmProductSales[style.PRODUCT_STYLE] && not empty jpms.value.jpmProductSales[style.PRODUCT_STYLE][size.PRODUCT_SIZE] }">
						    ...
						    <c:if test="${jpms.value.jpmProductSales[style.PRODUCT_STYLE][size.PRODUCT_SIZE].jpmProduct.productNo=='NLC000000000CN0' }">
						    2<input type='hidden' name='qty' value='2' size='2' id=qty<c:out value="${jpms.value.jpmProductSales[style.PRODUCT_STYLE][size.PRODUCT_SIZE].uniNo }2" />>
						    </c:if> 
						    ...
						    <script>
								...
								aSub2[<c:out value="${jpms.value.jpmProductSales[style.PRODUCT_STYLE][size.PRODUCT_SIZE].uniNo }" />2]['qty']='<c:if test="${jpms.value.jpmProductSales[style.PRODUCT_STYLE][size.PRODUCT_SIZE].jpmProduct.productNo!='NLC000000000CN0'}">0</c:if><c:if test="${jpms.value.jpmProductSales[style.PRODUCT_STYLE][size.PRODUCT_SIZE].jpmProduct.productNo=='NLC000000000CN0'}">2</c:if>';
								aSub2[<c:out value="${jpms.value.jpmProductSales[style.PRODUCT_STYLE][size.PRODUCT_SIZE].uniNo }" />2]['price']='<c:out value="${jpms.value.jpmProductSales[style.PRODUCT_STYLE][size.PRODUCT_SIZE].storeFpPrice }" />';
								aSub2[<c:out value="${jpms.value.jpmProductSales[style.PRODUCT_STYLE][size.PRODUCT_SIZE].uniNo }" />2]['pv']='<c:out value="${jpms.value.jpmProductSales[style.PRODUCT_STYLE][size.PRODUCT_SIZE].storeFpPv }" />';
							</script><%--
							<jecs:label key="pd.price"/>${jpms.value.jpmProductSales[style.PRODUCT_STYLE][size.PRODUCT_SIZE].storeFpPrice }<br/>
							<jecs:label key="busi.direct.pv"/>${jpms.value.jpmProductSales[style.PRODUCT_STYLE][size.PRODUCT_SIZE].storeFpPv }
						--%></c:if>
...
<%-- <c:if test="${varStatus.count % 2 == 0  }"></c:if> --%>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td><br />
    	<jecs:code listCode="pmproduct.productcategory" value="${jpms.key }"/>,<jecs:label key="pd.price"/>${jpms.value.productInfo.storeFpPrice },<jecs:label key="busi.direct.pv"/>0<br />
		<br />
		<table id="tablemain" class="tree_grid" border="0" cellspacing="0" cellpadding="0" width="40%">
			<thead>
				<tr>
					...
					<c:forEach items="${jpms.value.size }" var="size">
						...
						<c:if test="${not empty jpms.value.jpmProductSales[style.PRODUCT_STYLE] && not empty jpms.value.jpmProductSales[style.PRODUCT_STYLE][size.PRODUCT_SIZE] }">
						    ...
						    <script>
								...
								aSub3[<c:out value="${jpms.value.jpmProductSales[style.PRODUCT_STYLE][size.PRODUCT_SIZE].uniNo }" />3]['price']='<c:out value="${jpms.value.jpmProductSales[style.PRODUCT_STYLE][size.PRODUCT_SIZE].storeFpPrice }" />';
