...
<frameset cols="350,*" frameborder="1">
	<frame src="<c:url value='pdWarehouses.html'/>?strAction=pdWarehouseTree&controlFlag=area" id="warehouseList" name="warehouseList" frameborder="1"/>
