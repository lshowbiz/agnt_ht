...
<form method="post" action="pdJpShipmentReport.html" id="warehouseStockReport">
<div class="searchBar">
	...
	<input type="hidden" name="showFlag" id="showFlag" value="show"/>
			...
			<input name="sOrderTime" type="text" id="sOrderTime" size="16" value="${param.sOrderTime}" readonly="readonly" class="readonly"/> 
			<img src="./images/calendar/calendar7.gif" id="img_sOrderTime" style="cursor: pointer;" title="<jecs:locale key="Calendar.TT.SEL_DATE"/>"/> 
			<script type="text/javascript"> 
				Calendar.setup({
				inputField     :    "sOrderTime", 
				ifFormat       :    "%Y-%m-%d",  
				button         :    "img_sOrderTime", 
				singleClick    :    true
				}); 
			</script>-<input name="eOrderTime" type="text" id="eOrderTime" size="16" value="${param.eOrderTime}" readonly="readonly" class="readonly"/>
			<img src="./images/calendar/calendar7.gif" id="img_eOrderTime" style="cursor: pointer;" title="<jecs:locale key="Calendar.TT.SEL_DATE"/>"/> 
			<script type="text/javascript"> 
				Calendar.setup({
				inputField     :    "eOrderTime", 
				ifFormat       :    "%Y-%m-%d",  
				button         :    "img_eOrderTime", 
				singleClick    :    true
				}); 
			</script>
...
function submitMe(showFlag) {
	var startTime= jq('#sOrderTime').val();
	var endTime =jq('#eOrderTime').val();
