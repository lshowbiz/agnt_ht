...
<form:form commandName="sysListValue" method="post" action="editSysListValueByKey.html" onsubmit="return validateForm(this)" id="sysListValueForm">
...
<form:hidden path="valueId"/>
	<tbody class="window" >
		<tr class="edit_tr">
			...
			<td>
				<span class="textbox">
				<form:input path="valueTitle" id="valueTitle" size="60" cssClass="textbox-text"/>
				</span>
		...
		<tr class="edit_tr">
			...
			<td align="left">
				<span class="textbox">
				<form:input path="orderNo" id="orderNo"  cssClass="textbox-text"/>
				</span>
			</td>
		</tr>
		...
		<tr>
			<td class="command" colspan="4" align="center">
				...
				<c:if test="${not empty sysListValue.valueId }">
				<jecs:power powerCode="deleteSysListValueByKey">
				<button type="submit" class="btn btn_sele" name="delete" onclick="bCancel=true;return confirmDelete(this.form,'SysListValueByKey')" ><jecs:locale key="operation.button.delete"/></button>
				</jecs:power>
				</c:if>
