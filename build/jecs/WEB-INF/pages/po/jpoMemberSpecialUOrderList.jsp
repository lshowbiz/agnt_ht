...
<form action="jpoMemberSpecialUOrders.html" method="get" name="searchForm" id="searchForm">
<div class="searchBar">
...
<input name="add" class="button" type="button" onclick="location.href='<c:url value="/editJpoMemberSpecialUOrder.html?strAction=addPoMemberSpecialUOrder"/>'" value="<jecs:locale key="member.new.num"/>" />
</c:if>
</jecs:power>
</div>
</form>
...
<ec:table 
	...
	action="${pageContext.request.contextPath}/jpoMemberSpecialUOrders.html"
	width="100%"
...
<c:if test="${sessionScope.sessionLogin.userType=='C'}">
   		...
   		<jecs:power powerCode="editPoMemberSpecialUOrder">
							<img src="<c:url value='/images/newIcons/pencil_16.gif'/>" 
								onclick="javascript:editJpoMemberSpecialUOrder('${jpoMemberOrder.moId}')"
...
<script type="text/javascript">
   ...
   function editJpoMemberSpecialUOrder(moId){
   		<jecs:power powerCode="editPoMemberSpecialUOrder">
					window.location="editJpoMemberSpecialUOrder.html?strAction=editPoMemberSpecialUOrder&moId="+moId;
			</jecs:power>
		}
