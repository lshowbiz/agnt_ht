...
<form action="jpoMemberOrderRenewalReport.html" method="get" name="searchForm" id="searchForm" onsubmit="return validateOthers(this)">
<table class="detail" width="70%">
	<tbody class="window" >
		...
		<tr class="edit_tr">
			...
			<td >
				<span class="textbox"><input name="fyear" type="text" id="fyear" value="${param['fyear'] }" size="12" class="textbox-text"/></span>
