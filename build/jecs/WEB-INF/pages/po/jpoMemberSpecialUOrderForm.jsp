...
<jecs:power powerCode="addPoMemberSpecialUOrder">
...
<jecs:power powerCode="editPoMemberSpecialUOrder">
				<input type="submit" class="button" name="save"  onclick="bCancel=false" value="<jecs:locale key="operation.button.save"/>" />
</jecs:power>
<jecs:power powerCode="deletePoMemberFOrder">
				<input type="submit" class="button" name="delete" onclick="bCancel=true;return confirmDelete(this.form,'PoMemberSpecialUOrder')" value="<jecs:locale key="operation.button.delete"/>" />
</jecs:power>
</c:if>

<input type="button" class="button" name="back"  onclick="window.location.href='jpoMemberSpecialUOrders.html?needReload=1'" value="<jecs:locale key="operation.button.return"/>" />
...
<form:form commandName="jpoMemberOrder" method="post" action="editJpoMemberSpecialUOrder.html" onsubmit="return onSubmitCheck(this);" id="jpoMemberOrderForm">
...
<c:if test='${param.strAction=="editPoMemberSpecialUOrder"}'>
    <tr><th>
    ...
    <td align="left">
    	...
    	<c:if test='${param.strAction=="addPoMemberSpecialUOrder"}'>
