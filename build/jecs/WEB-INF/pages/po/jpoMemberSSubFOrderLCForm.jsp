...
<div id="step2" style="display:none;width: 100%">
	<div class="searchBar">
		...
		<input type="button" class="button" name="back"  onclick="window.location.href='jpoMemberSSubFOrders.html?needReload=1'" value="<jecs:locale key="operation.button.return"/>" />
		<jecs:locale key="busi.order.amount"/><span id='total_price'>0</span>,<span><input type="hidden" value="0" id="fixed"/></span><jecs:locale key="poMemberOrder.pvAmt"/><span id='total_pv'>0</span>
	</div>
