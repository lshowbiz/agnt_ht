...
<form:form commandName="bdPeriod" method="post" action="jmiMemberUSPromotionsReport.html"  id="bdPeriodForm">
	...
	<form:hidden path="wid"/>
		...
		<tr>		
			<td class="command" colspan="4" align="center">
				<jecs:power powerCode="jmiMemberUSPromotionsReport">	
				<input type="submit" name="submit" value="<jecs:locale key="button.report"/>" class="btn btn_sele"/>
				</jecs:power>
				<input type="hidden" name="strAction" value="jmiMemberUSPromotionsReport"/>
			</td>
		</tr>
		</tbody>
	</table>
