...
<form name="updateForm" method="get" action="" id="updateForm">
	...
	<table class="detail" width="100%">
		...
		<tr>
			<th><jecs:title key="jmiLink.count" /></th>
			<td>
	...
	<c:if test="${count>0 }">
		...
		<input type="button" name="submit1" onclick="javascript:window.location.href='jmiLinkRefState.html'" value="<jecs:locale key="operation.button.return"/>" class="button"/>
	</c:if>
