...
<ec:table 
	tableId="jmiMemberRecordListTable"
	items="jmiMemberRecordList"
	var="jmiMemberRecord"
	action="${pageContext.request.contextPath}/jmiMemberRecord.html"
	width="100%"
	...
	rowsDisplayed="20" sortable="true" imagePath="./images/extremetable/*.gif">
		...
		<ec:row>
   			...
   			<ec:column property="sum_money" title="bonus.pv.total" />
   			<ec:column property="jbalance" title="fiSecurityDeposit.jbalance" />
   			<ec:column property="balance" title="bdSendRecord.currentDev" />
		</ec:row>
