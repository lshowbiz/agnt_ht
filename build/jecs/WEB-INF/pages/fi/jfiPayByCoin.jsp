...
<form id="jfiPayByCoin" method="POST" action="jfiPayByCoin.html?strAction=jfiPayByCoin&orderId=${param.orderId }" onsubmit="if(saveSub()){return validateOthers(this);}else{return false;};">
