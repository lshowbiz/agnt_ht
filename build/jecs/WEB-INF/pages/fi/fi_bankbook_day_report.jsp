...
<form method="post" action="fiBankbookDayReport.html"
		...
		<tbody class="window">
			...
			<tr>
				<td class="command" colspan="4" align="center">
					<jecs:power powerCode="fiBankbookDayReportJJ">
						<input type="submit" name="submit"
							value="<jecs:locale key="button.report"/>" class="btn btn_sele" />
					</jecs:power>
					<input type="hidden" name="strAction" value="fiBankbookDayReportJJ" />
				</td>
			</tr>
		</tbody>
	</table>
