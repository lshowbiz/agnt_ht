...
<form action="fiSettleStat.html" method="get"
...
<form action="/fiSettleStat.html" method="get" name="fiBankbookTempForm"
	...
	<ec:table tableId="fiBankbookTempListTable" items="fiBankbookTempList"
		...
		action="${pageContext.request.contextPath}/fiSettleStat.html"
