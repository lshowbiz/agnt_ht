...
function saveSub(){
	...
	if(${jpoMemberOrder.amount} > Number($('amount').value)+${bankbook}){
...
<form id="jfiPayByCoin" method="POST" action="jfiPayByJJ.html?strAction=jfiPayByJJ&orderId=${param.orderId }" onsubmit="if(saveSub()){return validateOthers(this);}else{return false;};">
