...
<form name="searchForm" action="jprRefunds.html" id="searchForm">
<input name="strAction" type="hidden" size="10" value="${param.strAction }" id="strAction">
<div class="searchBar">
...
<button name="add" type="button" onclick="location.href='<c:url value="/jprRefundBacking.html"/>?strAction=addPrRefund'" class="btn btn_ins" >
	...
	<ec:table 
		...
		items="jprRefundList"
		var="prRefund"
		action="${pageContext.request.contextPath}/jprRefunds.html"
		width="100%"
		...
		rowsDisplayed="20" sortable="true" imagePath="./images/extremetable/*.gif">
				...
				<ec:column property="status" title="title.operation" sortable="false" styleClass="centerColumn" style="width:100px;">
					...
					<a href="viewJprRefund.html?strAction=viewPrRefund&roNo=${prRefund.roNo}"><img border="0" src="images/newIcons/search_16.gif" alt="<jecs:locale key="function.menu.view"/>" /></a>
   					...
   					<jecs:power powerCode="editPrRefund">
					<img border="0" src="images/newIcons/pencil_16.gif" alt="<jecs:locale key="button.edit"/>" onclick="editJprRefundNew('${prRefund.roNo}')"/>
					</jecs:power>
					</nobr>
				</ec:column>
			</ec:row>
...
<script type="text/javascript">
       function editJprRefundNew(roNo){
             var strAction = "<%= request.getAttribute("strAction")%>";
             if("jprRefundsCheck"==strAction){
                 window.location.href = "editJprRefund.html?strAction=editPrRefund&strDifference=strDifference&roNo="+roNo;
             }else{
                 window.location.href = "editJprRefund.html?strAction=editPrRefund&roNo="+roNo;
             }
       }
</script>
