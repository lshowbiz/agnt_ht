...
// Node object
function Node(id, pid, name, check, url, title, target, icon, iconOpen, open) {
	this.id = id;
	this.check = check;
	this.pid = pid;
	this.name = name;
...
function dTree(objName) {
	...
	this.icon = {root:"images/dtree/base.gif", folder:"images/dtree/folder.gif", folderOpen:"images/dtree/folderopen.gif", node:"images/dtree/page.gif", empty:"images/dtree/empty.gif", line:"images/dtree/line.gif", join:"images/dtree/join.gif", joinBottom:"images/dtree/joinbottom.gif", plus:"images/dtree/plus.gif", plusBottom:"images/dtree/plusbottom.gif", minus:"images/dtree/minus.gif", minusBottom:"images/dtree/minusbottom.gif", nlPlus:"images/dtree/nolines_plus.gif", nlMinus:"../images/tree/nolines_minus.gif"};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
...
dTree.prototype.add = function (id, pid, name, check, url, title, target, icon, iconOpen, open) {
	this.aNodes[this.aNodes.length] = new Node(id, pid, name, check, url, title, target, icon, iconOpen, open);
};
