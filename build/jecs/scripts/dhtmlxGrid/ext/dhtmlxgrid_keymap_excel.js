...
dhtmlXGridObject.prototype._key_events={k13_1_0:function(){this.editStop()},
 ...
 this.callEvent("onEnter",[(this.row?this.row.idd:null),(this.cell?this.cell._cellIndex:null)]);this.selectCell(this.rowsCol[rowInd+1],this.cell._cellIndex,true)},
 k9_0_0:function(){this.editStop();if (this.cell && (this.cell._cellIndex+1)>=this._cCount) return;var z=this._getNextCell(null,1);if (z){this.selectCell(z.parentNode,z._cellIndex,(this.row!=z.parentNode),true);this._still_active=true}},
 k9_0_1:function(){this.editStop();if (this.cell && (this.cell._cellIndex==0)) return;var z=this._getNextCell(null,-1);if (z){this.selectCell(z.parentNode,z._cellIndex,(this.row!=z.parentNode),true);this._still_active=true}},
 ...
 k_other:function(ev){if (this.editor)return false;if (!ev.shiftKey && !ev.ctrlKey && ev.keyCode>=40 && ev.keyCode < 128)if (this.cell){this.cells4(this.cell).setValue();this.editCell()}}};
//v.1.5 build 71114
