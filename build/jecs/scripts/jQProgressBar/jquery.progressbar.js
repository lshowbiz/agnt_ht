	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				width		: 200,											// Width of the progressbar - don't forget to adjust your image too!!!
				boxImage	: 'images/jQProgressBar/progressbar.gif',		// boxImage : image around the progress bar
				barImage	: 'images/jQProgressBar/progressbg_green.gif',	// Image to use in the progressbar. Can be an array of images too.
