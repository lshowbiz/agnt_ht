...
<jecs:power powerCode="deletePoMemberAOrder">
				<input data-inline="true" type="submit" class="button" name="delete" onclick="bCancel=true;return confirmDelete(this.form,'PoMemberAOrder')" value="<jecs:locale key="operation.button.delete"/>" />
</jecs:power>
</c:if>

<input data-inline="true" type="button" class="button" name="back"  onclick="window.location.href='jpoMemberAOrders.html?needReload=1'" value="<jecs:locale key="operation.button.return"/>" />
