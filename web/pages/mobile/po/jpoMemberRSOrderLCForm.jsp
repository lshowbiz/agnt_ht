...
<jecs:power powerCode="addPoMemberRSOrderLC">
...
<jecs:power powerCode="editPoMemberRSOrderLC">
				<input data-inline="true" type="submit" class="button" name="save"  onclick="return nextSave();" value="<jecs:locale key="operation.button.save"/>" />
</jecs:power>
<jecs:power powerCode="deletePoMemberRSOrderLC">
				<input data-inline="true" type="submit" class="button" name="delete" onclick="bCancel=true;return confirmDelete(this.form,'PoMemberRSOrderLC')" value="<jecs:locale key="operation.button.delete"/>" />
</jecs:power>
</c:if>
...
<form:form commandName="jpoMemberOrder" method="post" action="editJpoMemberRSOrderLC.html" onsubmit="return formSub();" id="jpoMemberOrderForm">
...
<c:if test='${param.strAction=="editPoMemberRSOrderLC"}'>
    <tr><th>
    ...
    <td align="left">
    	...
    	<c:if test='${param.strAction=="addPoMemberRSOrderLC"}'>
