...
<c:if test='${empty jpoMemberOrder.moId}'>
	...
	onclick="window.location.href='editJpoMemberSFOrderLC.html?strAction=addPoMemberSFOrderLC'" 
	value="兰超" />
</c:if>
</jecs:power>
...
<jecs:power powerCode="deletePoMemberSFOrder">
	<input data-inline="true" type="submit" class="button" name="delete" onclick="bCancel=true;return confirmDelete(this.form,'PoMemberSFOrder')" value="<jecs:locale key="operation.button.delete"/>" />
</jecs:power>
</c:if>
