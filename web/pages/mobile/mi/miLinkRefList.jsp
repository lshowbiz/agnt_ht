...
<form action="" method="get" name="miMemberForm" id="miMemberForm" onsubmit='document.getElementById("search").disabled = true;' data-ajax="false" >
...
<div style="text-align: left;"><jecs:locale key="miLinkRef.total"/>:${empty miMemberCount?0:miMemberCount }</div>
