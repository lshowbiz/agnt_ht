...
<form:form commandName="bdPeriod" method="post" action="jmiStoreRepeatOrderReport.html" onsubmit="return validateOthers(this)" id="bdPeriodForm">
	...
	<form:hidden path="wid"/>
		...
		<jecs:power powerCode="jmiStoreRepeatOrderReport">	
				<input type="submit" name="submit" value="<jecs:locale key="button.report"/>" class="btn btn_sele"/>
				</jecs:power>
				<input type="hidden" name="strAction" value="jmiStoreRepeatOrderReport"/>
				</td>
		</tr>
		</tbody>
	</table>
