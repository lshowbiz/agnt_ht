...
<c:if test="${empty bdPeriod.wid}">
	<form:form commandName="bdPeriod" method="post"
		action="bdSendRecordAllotJPReport.html" id="bdPeriodForm">
			...
			<tbody class="window">				
					...
					<td>
						<span class="textbox">
							<input name="endAllotMoney" type="text"
								value="${param.endAllotMoney }" size="12" class="textbox-text"/>
						</span>
					</td>	
				<tr>
				</tr>			
					...
					<td colspan="3">
						<span class="textbox">
						 	<input name="remittanceDate" id="remittanceDate" type="text" class="textbox-text"
							value="${param.remittanceDate }" style="cursor: pointer;"
				...
				<tr>
					<td class="command" colspan="4" align="center">
						...
						<input type="hidden" name="strAction" value="bonusSendJPReport" />				
					</td>
				</tr>
			</tbody>
		</table>
