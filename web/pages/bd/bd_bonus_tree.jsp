...
<c:if test="${not empty bdSendRecords && empty param.type }">
<script>
$(function(){
    var map = [
...
<form method="get" action="bd_bonus_tree.html" onsubmit="return validateOthers(this)" id="bdPeriodForm">
	<div class="searchBar">
	...
	<%-- 
	<jecs:power powerCode="bdBonusTreeZC">
...
<jecs:locale key="bdBonus.tree.organize"/>: <a href="bd_bonus_tree.html?strAction=bdBonusTreeQuery&formatedWeek=${param.formatedWeek }&memberNo=${sessionScope.sessionLogin.userCode }">
...
<c:if test="${not empty upMiLinkRefs}">
	<c:forEach items="${upMiLinkRefs}" var="upMiLinkRefVar">
		/ <a href="bd_bonus_tree.html?strAction=bdBonusTreeQuery&formatedWeek=${param.formatedWeek }&memberNo=${upMiLinkRefVar.jmiMember.userCode }">
...
<table id="tablemain" class="tree_grid" width="100%">
	...
	<c:if test="${param.formatedWeek <201905 }">
		<tr>
			...
			<th><jecs:locale key="miLinkRef.total"/></th> 
			
			<%-- <th><jecs:locale key="bday.first_pv"/></th> --%>
			<th><jecs:locale key="bday.month_link_cypv"/></th>
			<th><jecs:locale key="bday.month_recommend_cxpv"/></th>
			
			
			<th><jecs:locale key="bdBonus.tree.personPv"/></th>
			<th><jecs:locale key="bdBonus.personFirstPv"/></th><!-- 当月个人首单业绩 -->
			<th><jecs:locale key="bdday.pending_recommend_pv2"/></th>
			<%-- <th><jecs:locale key="bdBonus.tree.groupPv"/></th> --%>
			<th><jecs:locale key="bdBonus.month_group_pv"/></th>
			
			<%-- <th><jecs:locale key="bdday.pending_pv"/></th> --%>
			<th><jecs:locale key="bd.month.area.total.pv"/></th>
			
				<%-- <th><jecs:locale key="jbdMemberLinkCalcHist.areaConsumption"/></th> --%>
			...
			<th><jecs:locale key="miMember.store.type"/></th>
			<c:if test="${sessionScope.sessionLogin.isMember==true}">
			<th>&nbsp;</th>
			</c:if>
		</tr>
		...
		<c:if test="${param.formatedWeek <201905 }">
			...
			<tr>
				<td>${bdSendRecordVar.user_code } - 
					<c:if test="${sessionScope.sessionLogin.userType=='C'}">
							${bdSendRecordVar.name } - ${bdSendRecordVar.pet_name }
					</c:if>
					<c:if test="${sessionScope.sessionLogin.userType!='C'}">
							${bdSendRecordVar.pet_name }
					</c:if>
				</td>
				<td><jecs:code listCode="member.level" value="${bdSendRecordVar.retain_level }"/></td>
				<td>
					<c:if test="${bdSendRecordVar.user_code==miMember.userCode}">&nbsp;</c:if>
					<c:if test="${bdSendRecordVar.user_code!=miMember.userCode}">${bdSendRecordVar.layer_id-miMember.jmiLinkRef.layerId }</c:if>
				</td>
				<td ><img src="images/bonus_tree/tree_star.gif" border="0"/> ${bdSendRecordVar.link_num }</td>
				...
				<%-- <td align="right"><img src="images/bonus_tree/tree_person_pv.gif" border="0"/> <fmt:formatNumber pattern="###,##0.00">${bdSendRecordVar.first_pv }</fmt:formatNumber></td>
				 --%>
				<td align="right"><img src="images/bonus_tree/tree_person_pv.gif" border="0"/> <fmt:formatNumber pattern="###,##0.00">${bdSendRecordVar.month_link_cypv }</fmt:formatNumber></td>
				<td align="right"><img src="images/bonus_tree/tree_person_pv.gif" border="0"/> <fmt:formatNumber pattern="###,##0.00">${bdSendRecordVar.month_link_cxpv }</fmt:formatNumber></td>
				
				
				
				<td align="right"><img src="images/bonus_tree/tree_person_pv.gif" border="0"/> <fmt:formatNumber pattern="###,##0.00">${bdSendRecordVar.month_consumer_pv+bdSendRecordVar.first_pv }</fmt:formatNumber></td>
				<td align="right"><img src="images/bonus_tree/tree_person_pv.gif" border="0"/> <fmt:formatNumber pattern="###,##0.00">${bdSendRecordVar.first_pv }</fmt:formatNumber></td>
				...
				<td align="right"><img src="images/bonus_tree/tree_person_pv.gif" border="0"/> <fmt:formatNumber pattern="###,##0.00">${bdSendRecordVar.month_area_total_pv }</fmt:formatNumber></td>
				
				
				<%-- <td align="right"><img src="images/bonus_tree/tree_person_pv.gif" border="0"/> <fmt:formatNumber pattern="###,##0.00">${bdSendRecordVar.area_consumption }</fmt:formatNumber></td> --%>
				...
				<c:if test="${doubleView=='1' }">
					...
					<td align="right"><img src="images/bonus_tree/tree_person_pv.gif" border="0"/> <fmt:formatNumber pattern="###,##0.00">${bdSendRecordVar.month_double_area_pv }</fmt:formatNumber></td>
					<td align="right"><img src="images/bonus_tree/tree_person_pv.gif" border="0"/> <fmt:formatNumber pattern="###,##0.00">${bdSendRecordVar.month_double_max_pv }</fmt:formatNumber></td>
				</c:if>
				...
				<c:if test="${sessionScope.sessionLogin.isMember==true}">
				<td><a href="bd_bonus_tree.html?strAction=bdBonusTreeQuery&formatedWeek=${param.formatedWeek }&memberNo=${bdSendRecordVar.user_code }"><img src="images/bonus_tree/next_5.png" border="0"/></a></td>
				</c:if>
			</tr>
			</c:if>
			<c:if test="${empty param.formatedWeek || param.formatedWeek >=201905 }">
				...
				<td align="right"><img src="images/bonus_tree/tree_person_pv.gif" border="0"/> <fmt:formatNumber pattern="###,##0.00">${bdSendRecordVar.month_own_pv }</fmt:formatNumber></td>
				<td align="right"><img src="images/bonus_tree/tree_person_pv.gif" border="0"/> <fmt:formatNumber pattern="###,##0.00">${bdSendRecordVar.first_pv }</fmt:formatNumber></td>
				<td align="right"><img src="images/bonus_tree/tree_person_pv.gif" border="0"/> <fmt:formatNumber pattern="###,##0.00">${bdSendRecordVar.week_group_pv }</fmt:formatNumber></td>
				<td align="right"><img src="images/bonus_tree/tree_person_pv.gif" border="0"/> <fmt:formatNumber pattern="###,##0.00">${bdSendRecordVar.month_area_total_pv }</fmt:formatNumber></td>
