...
<c:if test="${empty bdPeriod.wid}">
	<form:form commandName="bdPeriod" method="post"
		action="jbdSendTypeReport.html" onsubmit="return validateOthers(this)"
		id="bdPeriodForm">
			...
			<tbody class="window">		
				...
				<tr>
					<td class="command" colspan="4" align="center">			
						<jecs:power powerCode="jbdSendTypeReport">
							<input type="submit" name="submit"
								value="<jecs:locale key="button.report"/>" class="btn btn_sele" />
						</jecs:power>
						<input type="hidden" name="strAction" value="jbdSendTypeReport" />			
					</td>
				</tr>
			</tbody>
		</table>
