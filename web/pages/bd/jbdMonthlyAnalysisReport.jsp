...
<form:form commandName="bdPeriod" method="post" action="jbdMonthlyAnalysisReport.html" onsubmit="return validateOthers(this)" id="bdPeriodForm">
	...
	<form:hidden path="wid"/>
		...
		<tr class="edit_tr">
			<th><span class="text-font-style-tc"><jecs:locale key="miMember.memberNo" />:</span></th>
			<td >
				<span class="textbox"><input type="text" name="userCode" id="userCode" size="8" class="textbox-text"/></span>
			</td>
		...
		<tr>		
			<td class="command" colspan="4" align="center">
				<jecs:power powerCode="jbdMonthlyAnalysisReport">	
				<input type="submit" name="submit" value="<jecs:locale key="button.report"/>" class="btn btn_sele"/>
				</jecs:power>
				<input type="hidden" name="strAction" value="jbdMonthlyAnalysisReport"/>
			</td>
		</tr>
		</tbody>
	</table>
