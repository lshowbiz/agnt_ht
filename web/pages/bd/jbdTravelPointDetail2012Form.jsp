...
<spring:bind path="jbdTravelPointDetail2012.*">
...
<form:form commandName="jbdTravelPointDetail2012" method="post" action="editJbdTravelPointDetail2012.html"  onsubmit="if(isFormPosted()){return true;}{return false;}" id="jbdTravelPointDetailForm">
...
<form:hidden path="id"/>
    ...
    <td align="left">
	  <jecs:list name="travelType" id="travelType" listCode="bd.traveltype.2012" value="${jbdTravelPointDetail2012.travelType}" defaultValue="" showBlankLine="true"/>
