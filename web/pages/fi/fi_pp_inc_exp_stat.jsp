...
<form action="fiPpIncExpStat.html" method="get"
...
<form action="" method="get" name="fiBankbookJournalForm"
	...
	<ec:table tableId="fiBankbookJournalListTable"
		...
		action="${pageContext.request.contextPath}/fiPpIncExpStat.html"
...
function viewfiBankbookJournal(journalId){
	<jecs:power powerCode="fiViewProductPointJournal">
		window.location="fiViewProductPointJournal.html?strAction=viewFiBankbookJournalJJ&journalId="+journalId;
	</jecs:power>
}
