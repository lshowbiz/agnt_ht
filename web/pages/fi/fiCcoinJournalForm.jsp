...
<title><jecs:locale key="fiCcoinJournalDetail.title"/></title>
<content tag="heading"><jecs:locale key="fiCcoinJournalDetail.heading"/></content>
...
<c:set var="buttons">
		...
		<jecs:power powerCode="deleteFiCcoinJournal">
				<input type="submit" class="button" name="delete" onclick="bCancel=true;return confirmDelete(this.form,'FiCcoinJournal')" value="<jecs:locale key="button.delete"/>" />
		</jecs:power>
</c:set>

<spring:bind path="fiCcoinJournal.*">
...
<form:form commandName="fiCcoinJournal" method="post" action="editFiCcoinJournal.html" onsubmit="return validateFiCcoinJournal(this)" id="fiCcoinJournalForm">
...
<legend>
				<input type="submit" class="button" name="save"  onclick="bCancel=false" value="<jecs:locale key="button.save"/>" />
        <input type="submit" class="button" name="delete" onclick="bCancel=true;return confirmDelete('FiCcoinJournal')" value="<jecs:locale key="button.delete"/>" />
...
<form:hidden path="journalId"/>
    ...
    <tr><th>
        <jecs:label  key="fiCcoinJournal.userCode"/>
    </th>
    <td align="left">
    ...
    <tr><th>
        <jecs:label  key="fiCcoinJournal.serial"/>
    </th>
    <td align="left">
    ...
    <tr><th>
        <jecs:label  key="fiCcoinJournal.dealType"/>
    </th>
    <td align="left">
    ...
    <tr><th>
        <jecs:label  key="fiCcoinJournal.dealDate"/>
    </th>
    <td align="left">
    ...
    <tr><th>
        <jecs:label  key="fiCcoinJournal.coin"/>
    </th>
    <td align="left">
    ...
    <tr><th>
        <jecs:label  key="fiCcoinJournal.notes"/>
    </th>
    <td align="left">
    ...
    <tr><th>
        <jecs:label  key="fiCcoinJournal.balance"/>
    </th>
    <td align="left">
    ...
    <tr><th>
        <jecs:label  key="fiCcoinJournal.remark"/>
    </th>
    <td align="left">
    ...
    <tr><th>
        <jecs:label  key="fiCcoinJournal.createrCode"/>
    </th>
    <td align="left">
    ...
    <tr><th>
        <jecs:label  key="fiCcoinJournal.createrName"/>
    </th>
    <td align="left">
    ...
    <tr><th>
        <jecs:label  key="fiCcoinJournal.createTime"/>
    </th>
    <td align="left">
    ...
    <tr><th>
        <jecs:label  key="fiCcoinJournal.moneyType"/>
    </th>
    <td align="left">
    ...
    <tr><th>
        <jecs:label  key="fiCcoinJournal.uniqueCode"/>
    </th>
    <td align="left">
    ...
    <tr><th>
        <jecs:label  key="fiCcoinJournal.appId"/>
    </th>
    <td align="left">
...
<script type="text/javascript">
    Form.focusFirstElement($('fiCcoinJournalForm'));
</script>

<v:javascript formName="fiCcoinJournal" cdata="false" dynamicJavascript="true" staticJavascript="false"/>
