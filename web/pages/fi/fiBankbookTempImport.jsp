	...
	<table class='detail' width="70%">
		<tbody class="window">				
			...
			<tr class="edit_tr">
				...
				<td colspan="3" >
				 	<jecs:locale key="fiBankbookTemp.import.notice.text.jj" />
					<br />
					<br />
			...
			<tr>
				<td class="command" colspan="4" align="center">
					<input type="hidden" name="strAction" value="importFiBankbookTempJJ" />
					...
					<input type="button" class="btn btn_sele" name="cancel"
						onclick="window.location='fiBankbookTemps.html?strAction=listfiBankbookTempsJJ&needReload=1';"
