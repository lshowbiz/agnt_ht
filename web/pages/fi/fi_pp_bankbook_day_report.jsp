...
<form method="post" action="fiPpBankbookDayReport.html"
	...
	<table class='detail' width="70%">
		<tbody class="window">
			...
			<tr class="edit_tr">
				...
				<td>
					<span class="textbox">
						<jecs:list listCode="fiproductpointtemp.productpointtype" styleClass="textbox-text"
							name="bankbookType" id="bankbookType"
							value="${param.bankbookType}" defaultValue="1" />
					</span>
				</td>
				<th>
					<span class="text-font-style-tc">
			...
			<tr>
				<td class="command" colspan="4" align="center">
					<jecs:power powerCode="fiPpBankbookDayReport">
						<input type="submit" name="submit"
							value="<jecs:locale key="button.report"/>" class="btn btn_sele" />
					</jecs:power>
					<input type="hidden" name="strAction" value="fiPpBankbookDayReport" />
				</td>
			</tr>
		</tbody>
	</table>
