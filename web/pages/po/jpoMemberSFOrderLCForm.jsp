...
<jecs:power powerCode="deletePoMemberSFOrderLC">
				<input type="submit" class="button" name="delete" onclick="bCancel=true;return confirmDelete(this.form,'PoMemberSFOrderLC')" value="<jecs:locale key="operation.button.delete"/>" />
</jecs:power>
</c:if>
...
<input type="button" class="button" name="back"  onclick="window.location.href='jpoMemberSFOrders.html?needReload=1'" value="<jecs:locale key="operation.button.return"/>" />
