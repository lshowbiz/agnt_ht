...
<form name="formAiFeat" method="post" action="jpoMemberOrderPHStatistic.html" >
	<table class="detail" width="100%">
		<tr>
			...
			<td>
				...
				<input type="submit" name="submit" onclick="javascript:this.form.action='jpoMemberOrderPHStatistic.html'" value="<jecs:locale key="operation.button.create"/>" class="button"/>
			</td>
		</tr>
	</table>
</form>