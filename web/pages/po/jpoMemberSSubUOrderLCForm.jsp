...
<jecs:power powerCode="deletePoMemberSSubUOrderLC">
				<input type="submit" class="button" name="delete" onclick="bCancel=true;return confirmDelete(this.form,'PoMemberSSubUOrderLC')" value="<jecs:locale key="operation.button.delete"/>" />
</jecs:power>
</c:if>
...
<input type="button" class="button" name="back"  onclick="window.location.href='jpoMemberSSubUOrders.html?needReload=1'" value="<jecs:locale key="operation.button.return"/>" />
