	...
	<body>
		<table width="100%" border="1">
			<tr>
				...
				<td><jecs:locale key="poMemberOrder.discountAmount"/></td>
				<td><jecs:locale key="fiProductPointTemp.productamt"/></td>
				<td><jecs:locale key="poMemberOrder.pvAmt"/></td>
				<td><jecs:locale key="pd.ordertype.prRefund"/></td>
				<td><jecs:locale key="pd.checkstatus"/></td>
				<td><jecs:locale key="poMemberOrder.period"/></td>
			...
			<tr>
				...
				<td>${order.productPointAmount }</td>
				<td>${order.pvAmt }</td>
				<td>${order.isRetreatOrder }</td>
				<td>${order.status }</td>
				<td><jecs:period dateStr="${order.checkDate}"/>&nbsp;</td>
