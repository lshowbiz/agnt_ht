...
<jecs:power powerCode="deletePoMemberSSubROrder">
				<button style="font-size:14px;height:30px;" type="submit" class="btn btn_sele" name="delete" onclick="bCancel=true;return confirmDelete(this.form,'PoMemberSSubROrder')" >
					<jecs:locale key="operation.button.delete"/>
				</button>
</jecs:power>
</c:if>

<button style="font-size:14px;height:30px;" type="button" class="btn btn_sele" name="back"  onclick="window.location.href='jpoMemberSSubROrders.html?needReload=1'">
...
function searchMiMember(){
	...
	window.location.href="editJpoMemberSSubROrder.html?strAction=addPoMemberSSubROrder&sysUser.userCode="+userCode;
}
</script>
<script>
  var aSub = Array();
