...
dhtmlXGridObject.prototype._key_events={k13_1_0:function(){this.editStop()},
 ...
 k9_0_0:function(){this.editStop();var z=this._getNextCell(null,1);if (z){this.selectCell(z.parentNode,z._cellIndex,(this.row!=z.parentNode),false,true);this._still_active=true};if (this.editor && this.editor.obj)this.editor.obj.select()},
 ...
 k40_0_0:function(){if (this.editor && this.editor.combo)this.editor.shiftNext();else{var rowInd = rowInd=this.rowsCol._dhx_find(this.row)+1;if (rowInd!=this.rowsCol.length && rowInd!=this.obj.rows.length-1){var nrow=this._nextRow(rowInd-1,1);if (nrow._sRow || nrow._rLoad)return false;this.selectCell(nrow,this.cell._cellIndex,false,false,true);if (this.editor && this.editor.obj)this.editor.obj.select()}else this._key_events.k34_0_0.apply(this,[])}},
 ...
 k33_0_0:function(){if(this.pagingOn)this.changePage(this.currentPage-1);else this.scrollPage(-1)},
 k34_0_0:function(){if(this.pagingOn)this.changePage(this.currentPage+1);else this.scrollPage(1)}, 
 k38_0_0:function(){if (this.editor && this.editor.combo)this.editor.shiftPrev();else{var rowInd = rowInd=this.rowsCol._dhx_find(this.row)+1;if (rowInd!=-1){var nrow=this._nextRow(rowInd-1,-1);if (!nrow || nrow._sRow || nrow._rLoad)return false;this.selectCell(nrow,this.cell._cellIndex,false,false,true);if (this.editor && this.editor.obj)this.editor.obj.select()}else this._key_events.k33_0_0.apply(this,[])}}};
//v.1.5 build 71114
