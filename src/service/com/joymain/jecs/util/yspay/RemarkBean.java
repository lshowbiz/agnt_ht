...
public class RemarkBean {
	...
	public String toArrayString() {
		...
		return String.format(fmt, new Object[] { userCode, payType, dataType, merchantId, payFee, zmType });
	}

	public static void main(String[] args) {
		JSONArray json = JSONArray.fromObject(new RemarkBean("sadf", "asf", "", "", true, new BigDecimal("0.00")));
		System.out.println(json);

		String reserved = json.toString();
		System.out.println(PayUtils.getRemarkBean(reserved));

		reserved = reserved.substring(reserved.indexOf("[") + 1, reserved.indexOf("]"));

		JSONObject jsonObj1 = JSONObject.fromObject(reserved);
		RemarkBean bean = (RemarkBean) JSONObject.toBean(jsonObj1, RemarkBean.class);
