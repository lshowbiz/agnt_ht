...
// Generated 2015-9-16 15:40:21 by Hibernate Tools 3.1.0.beta4
 ...
 * @hibernate.class
 *         table="JFI_REAPAL_LOG"
 *     
 */

public class JfiReapalLog extends com.joymain.jecs.model.BaseObject implements java.io.Serializable {


    // Fields    

    private Long logId;//自增ID
    private String companyCode;//区域国别
    ...
    private String detailId;//融宝平台流水
    private String detailTime;//融宝平台交易时间
    private String bankId;//银行编号
    private String bankDealId;//银行处理流水
    private String amount;//付款金额
    private String amtType;//付款金额
    ...
    private String url;//融宝发送付款通知的URL
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof JfiReapalLog) ) return false;
		 JfiReapalLog castOther = ( JfiReapalLog ) other; 
