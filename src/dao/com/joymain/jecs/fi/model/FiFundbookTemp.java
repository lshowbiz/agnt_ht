...
// Generated 2014-4-2 9:31:43 by Hibernate Tools 3.1.0.beta4
 ...
 * @hibernate.class
 *         table="FI_FUNDBOOK_TEMP"
 *     
 */

public class FiFundbookTemp extends com.joymain.jecs.model.BaseObject implements java.io.Serializable {
    ...
    private Long serial;
    private String dealType;//交易类别，A：存入；D：取出
    private Integer moneyType;
    private BigDecimal money;
    private String notes;
    private Integer status;//状态:1:新单 2:核准 3:未核准
    ...
    private Integer checkType;//核准方式 0:手工 1:自动
    ...
    /** default constructor */
    public FiFundbookTemp() {
    }

	/** minimal constructor */
    public FiFundbookTemp(String companyCode, String userCode, String bankbookType) {
    ...
    /** full constructor */
    public FiFundbookTemp(String companyCode, String userCode, Long serial, String dealType, Integer moneyType, BigDecimal money, String notes, Integer status, String createrCode, String createrName, Date createTime, String lastUpdaterCode, String lastUpdaterName, Date lastUpdateTime, String checkerCode, String checkerName, Date checkeTime, Integer checkType, Date dealDate, String checkMsg, String createNo, String bankbookType) {
        this.companyCode = companyCode;
        this.userCode = userCode;
        this.serial = serial;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof FiFundbookTemp) ) return false;
		 FiFundbookTemp castOther = ( FiFundbookTemp ) other; 
