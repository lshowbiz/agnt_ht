 ...
 * @hibernate.class
 *         table="FI_LOVECOIN_BALANCE"
 *     
 */

public class FiLovecoinBalance extends com.joymain.jecs.model.BaseObject implements java.io.Serializable {
...
//	}
    ...
    /** default constructor */
    public FiLovecoinBalance() {
    }

    
    /** full constructor */
    public FiLovecoinBalance(BigDecimal balance) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof FiLovecoinBalance) ) return false;
		 FiLovecoinBalance castOther = ( FiLovecoinBalance ) other; 
