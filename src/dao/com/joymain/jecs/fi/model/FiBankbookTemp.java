 ...
 * @hibernate.class
 *         table="FI_BANKBOOK_TEMP"
 *     
 */
@SuppressWarnings({"serial","unused"})
public class FiBankbookTemp extends com.joymain.jecs.model.BaseObject implements java.io.Serializable {
    ...
    /** default constructor */
    public FiBankbookTemp() {
    }

	/** minimal constructor */
    public FiBankbookTemp(String companyCode, String userCode, String bankbookType) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof FiBankbookTemp) ) return false;
		 FiBankbookTemp castOther = ( FiBankbookTemp ) other; 
