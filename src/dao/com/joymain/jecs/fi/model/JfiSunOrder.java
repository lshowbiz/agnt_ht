...
// Generated 2010-11-16 11:14:21 by Hibernate Tools 3.1.0.beta4
...
public class JfiSunOrder extends com.joymain.jecs.model.BaseObject implements java.io.Serializable {
    ...
    private JfiSunJmiMember jfiSunJmiMember;
	...
	private Set jfiSunOrderList = new HashSet(0);
    ...
    /** full constructor */
    public JfiSunOrder(String companyCode, String countryCode, String memberOrderNo, String orderType, String userCode, String userSpCode, BigDecimal amount, BigDecimal pvAmt, BigDecimal consumerAmount, String payMode, String orderUserCode, Date orderTime, String status, Date checkTime, String checkUserCode, Date checkDate, String remark, String pickup, Date submitTime, String submitUserCode, String submitStatus, String locked, String firstName, String lastName, String province, String city, String district, String address, String postalcode, String phone, String email, String mobiletele, String agentNo, BigDecimal samount) {
     ...
     */
     public String toString() {
      ...
      buffer.append("samount").append("='").append(getSamount()).append("' ");			
      buffer.append("]");
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof JfiSunOrder) ) return false;
		 JfiSunOrder castOther = ( JfiSunOrder ) other; 
 ...
 && ( (this.getSamount()==castOther.getSamount()) || ( this.getSamount()!=null && castOther.getSamount()!=null && this.getSamount().equals(castOther.getSamount()) ) );
   }
   ...
   public int hashCode() {
         ...
         result = 37 * result + ( getSamount() == null ? 0 : this.getSamount().hashCode() );
         return result;
   }
   ...
   /**
	 ...
	 * @hibernate.collection-one-to-many class="com.joymain.jecs.fi.model.JfiSunOrderList"
	 * 
	 */
public Set getJfiSunOrderList() {
	return jfiSunOrderList;
}

public void setJfiSunOrderList(Set jfiSunOrderList) {
	this.jfiSunOrderList = jfiSunOrderList;
}
 ...
 * 
 */
public JfiSunJmiMember getJfiSunJmiMember() {
	return jfiSunJmiMember;
}

public void setJfiSunJmiMember(JfiSunJmiMember jfiSunJmiMember) {
	this.jfiSunJmiMember = jfiSunJmiMember;
}
