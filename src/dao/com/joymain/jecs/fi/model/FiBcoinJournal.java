 ...
 * @hibernate.class
 *         table="FI_BCOIN_JOURNAL"
 *     
 */
@SuppressWarnings({ "unused", "serial" })
public class FiBcoinJournal extends com.joymain.jecs.model.BaseObject implements java.io.Serializable {
...
//    }
    ...
    /** full constructor */
    public FiBcoinJournal(String userCode, Integer serial, String dealType, Date dealDate, BigDecimal coin, String notes, BigDecimal balance, String remark, String createrCode, String createrName, Date createTime, Integer moneyType, String uniqueCode, Long appId,String dataType) {
//        this.userCode = userCode;
        this.serial = serial;
...
//      buffer.append("userCode").append("='").append(getUserCode()).append("' ");			
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof FiBcoinJournal) ) return false;
		 FiBcoinJournal castOther = ( FiBcoinJournal ) other; 
