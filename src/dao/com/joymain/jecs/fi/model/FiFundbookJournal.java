...
// Generated 2014-4-2 9:30:47 by Hibernate Tools 3.1.0.beta4
 ...
 * @hibernate.class
 *         table="FI_FUNDBOOK_JOURNAL"
 *     
 */

public class FiFundbookJournal extends com.joymain.jecs.model.BaseObject implements java.io.Serializable {
    ...
    private Integer moneyType;//资金类别
    private String uniqueCode;//唯一码，用于防止重复
    private String bankbookType;//基金类型：1，分红基金；2，定向基金。（区别：分红基金可以1:1比例转发展基金，以1：5的比例(5倍)转自己的定向基金，以1:1比例转入他人分红基金账户；定向基金只能以1:1比例转入他人定向基金账户）
    ...
    /** default constructor */
    public FiFundbookJournal() {
    }

	/** minimal constructor */
    public FiFundbookJournal(String companyCode, String userCode, String bankbookType) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof FiFundbookJournal) ) return false;
		 FiFundbookJournal castOther = ( FiFundbookJournal ) other; 
