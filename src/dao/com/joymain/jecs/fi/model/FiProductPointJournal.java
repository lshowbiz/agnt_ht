 ...
 * @hibernate.class
 *         table="FI_PRODUCT_POINT_JOURNAL"
 *     
 */
@SuppressWarnings({"serial","unused"})
public class FiProductPointJournal extends com.joymain.jecs.model.BaseObject implements java.io.Serializable {
    ...
    private FiProductPointTemp fiProductPointTemp;
    ...
    /** default constructor */
    public FiProductPointJournal() {
    }

	/** minimal constructor */
    public FiProductPointJournal(String companyCode, String userCode, String productPointType) {
    ...
    /** full constructor */
    public FiProductPointJournal(Long tempId, String companyCode, String userCode, Long serial, String dealType, Date dealDate, BigDecimal money, String notes, BigDecimal balance, String remark, String createrCode, String createrName, Date createTime, Integer moneyType, String uniqueCode, String productPointType, Long lastJournalId, BigDecimal lastMoney,String dataType) {
        //this.tempId = tempId;
        this.companyCode = companyCode;
        //this.userCode = userCode;
        this.serial = serial;
     ...
     * 
     */
    public FiProductPointTemp getFiProductPointTemp() {
    	return fiProductPointTemp;
    }

    public void setFiProductPointTemp(FiProductPointTemp fiProductPointTemp) {
    	this.fiProductPointTemp = fiProductPointTemp;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof FiProductPointJournal) ) return false;
		 FiProductPointJournal castOther = ( FiProductPointJournal ) other; 
