 ...
 * @hibernate.class
 *         table="FI_CHANNEL_LOG"
 *     
 */

public class FiChannelLog extends com.joymain.jecs.model.BaseObject implements java.io.Serializable {
	...
	/** minimal constructor */
    public FiChannelLog(String companyCode, String userCode, String inc, String returnMsg) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof FiChannelLog) ) return false;
		 FiChannelLog castOther = ( FiChannelLog ) other; 
