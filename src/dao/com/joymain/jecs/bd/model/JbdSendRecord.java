 ...
 * @hibernate.class
 *         table="JBD_SEND_RECORD"
 *     
 */

public class JbdSendRecord extends com.joymain.jecs.model.BaseObject implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof JbdSendRecord) ) return false;
		 JbdSendRecord castOther = ( JbdSendRecord ) other; 
