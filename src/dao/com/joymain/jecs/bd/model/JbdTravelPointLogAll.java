...
// Generated 2016-1-15 17:18:28 by Hibernate Tools 3.1.0.beta4
 ...
 * @hibernate.class
 *         table="JBD_TRAVEL_POINT_LOG_ALL"
 *     
 */

public class JbdTravelPointLogAll extends com.joymain.jecs.model.BaseObject implements java.io.Serializable {
    ...
    private BigDecimal passStar;


    // Constructors

    /** default constructor */
    public JbdTravelPointLogAll() {
    }

	/** minimal constructor */
    public JbdTravelPointLogAll(BigDecimal fyear) {
        this.fyear = fyear;
    }
    
    /** full constructor */
    public JbdTravelPointLogAll(BigDecimal fyear, String userCode, String createUser, Date createTime, BigDecimal usePoint, String dealType, String remark, Integer wmonth, BigDecimal passStar) {
        this.fyear = fyear;
    ...
    public BigDecimal getPassStar() {
        return this.passStar;
    }
    
    public void setPassStar(BigDecimal passStar) {
        this.passStar = passStar;
    }
     ...
     */
     public String toString() {
      ...
      buffer.append("fyear").append("='").append(getFyear()).append("' ");			
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof JbdTravelPointLogAll) ) return false;
		 JbdTravelPointLogAll castOther = ( JbdTravelPointLogAll ) other; 
 ...
 && ( (this.getFyear()==castOther.getFyear()) || ( this.getFyear()!=null && castOther.getFyear()!=null && this.getFyear().equals(castOther.getFyear()) ) )
