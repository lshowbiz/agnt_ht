 ...
 * @hibernate.class
 *         table="JBD_SEND_RECORD_HIST"
 *     dynamic-update="true"
 *     
 */

public class JbdSendRecordHist extends com.joymain.jecs.model.BaseObject implements java.io.Serializable {
     ...
     */
     public String toString() {
      ...
      buffer.append("patName").append("='").append(getPetName()).append("' ");			
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof JbdSendRecordHist) ) return false;
		 JbdSendRecordHist castOther = ( JbdSendRecordHist ) other; 
