 ...
 * @hibernate.class
 *         table="JBD_YD_399_RECOMMEND_LIST"
 *     
 */

public class JbdYd399RecommendList {
...
//	private String userCode;  // 会员编号'
	...
	public JbdYd399RecommendList() {
		super();
	}

    public JbdYd399RecommendList(Long id, String miUserName, Integer memberLevel, Date calcTime,
			String recommendNo, BigDecimal recommendAmount, BigDecimal sendAmount, Integer memberType,
			Integer freezeStatus, Integer sendStatus,Integer ydStoreLevel,  Date sendDate, String sendOperator) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		JbdYd399RecommendList other = (JbdYd399RecommendList) obj;
		if (calcTime == null) {
	...
	public String toString() {
		return "JbdYd399RecommendList [id=" + id + ", miUserName=" + miUserName
