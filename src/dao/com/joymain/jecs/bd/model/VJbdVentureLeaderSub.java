 ...
 * @hibernate.class
 *         table="V_JBD_VENTURE_LEADER_SUB"
 *     
 */

public class VJbdVentureLeaderSub extends com.joymain.jecs.model.BaseObject implements java.io.Serializable {
    ...
    /**       
     *      *            @hibernate.property
     *             column="REMEMBER_LEVEL"
     *         
     */
	  public Integer getRememberLevel() {
			return rememberLevel;
		}


		public void setRememberLevel(Integer rememberLevel) {
			this.rememberLevel = rememberLevel;
		}



	/** default constructor */
    public VJbdVentureLeaderSub() {
    }
	...
	/** full constructor */
    public VJbdVentureLeaderSub(Integer wyear, Integer wmonth, Integer wweek, String companyCode, String userCode, String bounsType, BigDecimal nlevel, String recommendedCode, BigDecimal passGroupPv, BigDecimal bounsPoint, BigDecimal bounsMoney) {
        this.wyear = wyear;
        this.wmonth = wmonth;
        this.wweek = wweek;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof VJbdVentureLeaderSub) ) return false;
		 VJbdVentureLeaderSub castOther = ( VJbdVentureLeaderSub ) other; 
