 ...
 * @hibernate.class
 *         table="V_JBD_SELL_CALC_SUB_DETAIL"
 *     
 */

public class VJbdSellCalcSubDetail extends com.joymain.jecs.model.BaseObject implements java.io.Serializable {
     ...
     *         
     */
    public BigDecimal getBounsRate() {
		return bounsRate;
	}


	public void setBounsRate(BigDecimal bounsRate) {
	...
	/** default constructor */
    public VJbdSellCalcSubDetail() {
    }

    
    /** full constructor */
    public VJbdSellCalcSubDetail(Integer wyear, Integer wmonth, Integer wweek, String userCode, BigDecimal nlevel, String recommendedCode, String recommendedCompanyCode, String recommendedOrderNo, String recommendedOrderClass, String recommendedOrderType, BigDecimal pv) {
        this.wyear = wyear;
        this.wmonth = wmonth;
        this.wweek = wweek;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof VJbdSellCalcSubDetail) ) return false;
		 VJbdSellCalcSubDetail castOther = ( VJbdSellCalcSubDetail ) other; 
