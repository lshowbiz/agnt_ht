...
public class JbdDayCustRecommendOrder {
    ...
    public JbdDayCustRecommendOrder(Long id, Integer wweek, String userCode, String reuserCode, Integer recommendLvl,
			String memberOrderNo, Integer orderType, BigDecimal orderMoney, BigDecimal recommendPv, BigDecimal comRate,
			Date comDate, BigDecimal sendFlag) {
		super();
		this.id = id;
		this.wweek = wweek;
	...
	public int hashCode() {
		...
		result = prime * result + ((sendFlag == null) ? 0 : sendFlag.hashCode());
	...
	public String toString() {
		return "JbdDayCustRecommendOrder [id=" + id + ", wweek=" + wweek + ", userCode=" + userCode + ", reuserCode="
				+ reuserCode + ", recommendLvl=" + recommendLvl + ", memberOrderNo=" + memberOrderNo + ", orderType="
				+ orderType + ", orderMoney=" + orderMoney + ", recommendPv=" + recommendPv + ", comRate=" + comRate
				+ ", comDate=" + comDate + ", sendFlag=" + sendFlag + "]";
	}
