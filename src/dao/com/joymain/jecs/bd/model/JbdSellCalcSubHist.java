 ...
 * @hibernate.class
 *         table="JBD_SELL_CALC_SUB_HIST"
 *     
 */

public class JbdSellCalcSubHist extends com.joymain.jecs.model.BaseObject implements java.io.Serializable {
    ...
    /** default constructor */
    public JbdSellCalcSubHist() {
    }

    
    /** full constructor */
    public JbdSellCalcSubHist(Integer wyear, Integer wmonth, Integer wweek, String userCode, String linkNo, String companyCode, String cardType, BigDecimal groupPv, BigDecimal bounsPoint, BigDecimal bounsPv, BigDecimal keepPv, BigDecimal lastKeepPv, Integer serialNumber) {
        this.wyear = wyear;
        this.wmonth = wmonth;
        this.wweek = wweek;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof JbdSellCalcSubHist) ) return false;
		 JbdSellCalcSubHist castOther = ( JbdSellCalcSubHist ) other; 
