 ...
 * @hibernate.class
 *         table="JBD_MEMBER_LINK_CALC_HIST"
 *     
 */

public class JbdMemberLinkCalcHist extends com.joymain.jecs.model.BaseObject implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof JbdMemberLinkCalcHist) ) return false;
		 JbdMemberLinkCalcHist castOther = ( JbdMemberLinkCalcHist ) other; 
