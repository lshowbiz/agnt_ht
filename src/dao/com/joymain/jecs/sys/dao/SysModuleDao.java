...
public interface SysModuleDao extends Dao {
	...
	/**
	 * Gets sysModule's information based on primary key. An ObjectRetrievalFailureException Runtime Exception is thrown if nothing is found.
	 * 
