...
public class SysIdDaoHibernate extends BaseDaoHibernate implements SysIdDao {
    ...
    public List getSysIds(final SysId sysId) {
        return getHibernateTemplate().find("from SysId order by id desc");
    }
    ...
    public SysId getSysId(final Long id) {
        SysId sysId = (SysId) getHibernateTemplate().get(SysId.class, id);
        if (sysId == null) {
    ...
    public void saveSysId(final SysId sysId) {
        getHibernateTemplate().saveOrUpdate(sysId);
    }
    ...
    public void removeSysId(final Long id) {
        getHibernateTemplate().delete(getSysId(id));
    }
