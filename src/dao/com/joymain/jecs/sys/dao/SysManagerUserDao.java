...
public interface SysManagerUserDao extends Dao {
	...
	/**
	 * Gets sysManagerUser's information based on primary key. An ObjectRetrievalFailureException Runtime Exception is thrown if nothing is found.
	 * 
