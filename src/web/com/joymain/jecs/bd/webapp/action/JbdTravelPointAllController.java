...
public class JbdTravelPointAllController extends BaseController implements Controller {
    private final Log log = LogFactory.getLog(JbdTravelPointAllController.class);
    ...
    throws Exception {
        ...
        JbdTravelPointAll jbdTravelPointAll = new JbdTravelPointAll();
        // populate object with request parameters
        BeanUtils.populate(jbdTravelPointAll, request.getParameterMap());

	//List jbdTravelPointAlls = jbdTravelPointAllManager.getJbdTravelPointAlls(jbdTravelPointAll);
		/**** auto pagination ***/
		CommonRecord crm=RequestUtil.toCommonRecord(request);
		Pager pager = new Pager("jbdTravelPointAllListTable",request, 20);
		List jbdTravelPointAlls = null;
	    ...
	    if("export".equals(exportFlag)){
        	if(StringUtil.isEmpty(wmonth)){
        		request.setAttribute("jbdTravelPointAllListTable_totalRows", pager.getTotalObjects());
        		return new ModelAndView("bd/jbdTravelPointAllList", "jbdTravelPointAllList", jbdTravelPointAlls);
        	}
	        ...
	        jbdTravelPointAlls = jbdTravelPointAllManager.getJbdTravelPointAllsByCrm(crm,pager);
	        request.setAttribute("jbdTravelPointAllListTable_totalRows", pager.getTotalObjects());
        }
        /*****/
