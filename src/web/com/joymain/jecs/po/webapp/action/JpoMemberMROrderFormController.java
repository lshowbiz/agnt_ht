 ...
 *
 */
public class JpoMemberMROrderFormController extends BaseFormController {
    ...
    public JpoMemberMROrderFormController() {
    ...
    throws Exception {
        ...
        if ("deletePoMemberMROrder".equals(strAction) || "editPoMemberMROrder".equals(strAction) && !StringUtils.isEmpty(moId)){
            ...
            jpoMemberOrder.setOrderType("24");
...
//        String teamCode=jmiMemberTeamManager.teamStr(loginSysUser);//获取团队编号
    	...
    	if(loginSysUser.getIsMember()){
    		jpmProductSales = jpmProductSaleManager.getPmProductSalesNew(
    				...
    				Constants.DREAM_MAINTAIN_PURCHASE,"1",teamCode,loginSysUser);
    	}else{
    		jpmProductSales = jpmProductSaleManager.getPmProductSalesNew(
    				loginSysUser.getCompanyCode(),
    				Constants.DREAM_MAINTAIN_PURCHASE,"2",teamCode,loginSysUser);
    	}
