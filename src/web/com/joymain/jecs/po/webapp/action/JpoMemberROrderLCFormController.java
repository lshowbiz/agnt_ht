 ...
 *
 */
public class JpoMemberROrderLCFormController extends BaseFormController {
   /* private JpoMemberOrderManager jpoMemberOrderManager = null;
    ...
    public JpoMemberROrderLCFormController() {
    ...
    throws Exception {
        ...
        if ("deletePoMemberROrderLC".equals(strAction) || "editPoMemberROrderLC".equals(strAction) && !StringUtils.isEmpty(moId)){
    	...
    	if(RequestUtil.isMobileRequest(request)){
         	this.setFormView("/mobile/po/jpoMemberROrderLCForm");
         } else {
        	 this.setFormView("/po/jpoMemberROrderLCForm");
    ...
    throws Exception {
		...
		String key=null;
		String strAction = request.getParameter("strAction");
		if ("deletePoMemberROrderLC".equals(strAction)) {
			...
			if("addPoMemberROrderLC".equals(strAction)){
    ...
    *//**
    ...
    private int calcOrderAmount(HttpServletRequest request, Set jpoMemberOrderSet, Set jpoMemberOrderFeeSet, JpoMemberOrder jpoMemberOrder){
    	...
    	if(sumPV.compareTo(new BigDecimal("42"))==-1){
    		return 3;//小于600
    	}
    	boolean isDiscount = false;
		if("CN".equals(jpoMemberOrder.getCompanyCode()) && sumPV.compareTo(new BigDecimal("1638"))!=-1 ){
	    	java.util.Calendar startc=java.util.Calendar.getInstance();
	    	startc.set(2011, 4, 14, 00, 00, 00);
		...
		if("CN".equals(jpoMemberOrder.getCompanyCode())&&isDiscount==false){
