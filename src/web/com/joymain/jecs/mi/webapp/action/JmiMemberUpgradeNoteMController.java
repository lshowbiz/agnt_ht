...
public class JmiMemberUpgradeNoteMController extends BaseController implements Controller {
    private final Log log = LogFactory.getLog(JmiMemberUpgradeNoteMController.class);
