 ...
 *
 */
public class ChanjetCheckOrderStateTwoController extends BaseController implements Controller {

    private final Log log = LogFactory.getLog(ChanjetCheckOrderStateTwoController.class);
    
	public ModelAndView handleRequest(HttpServletRequest request,
                                      HttpServletResponse response)
    throws Exception {

        return new ModelAndView("chanjet/checkOrderState_two");
    }
}
