 ...
 *
 */
public class FiSettleStatController extends BaseController implements Controller {
	private final Log log = LogFactory.getLog(FiSettleStatController.class);
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        RequestUtil.freshSession(request,"fiSettleStatJJ",3l);
       ...
       /* CustomField[] fields = crm.getFields();
		...
		List fiBankbookTemps = this.fiBankbookTempManager.getFiBankbookTempsByCrm(crm, pager);
		//根据数据重新设置分页数据
		...
		return new ModelAndView("fi/fi_settle_stat", Constants.FIBANKBOOKTEMP_LIST, fiBankbookTemps);
	}
}