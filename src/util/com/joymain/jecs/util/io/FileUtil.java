...
public class FileUtil {
	 ...
	 * @throws Exception
	 */
	public static void appendToFile(String str, String FileName) throws Exception {
	...
	public static void saveBdLogger(String fileName,Date beginTime,Date endTime,String msg){
		Long begin=beginTime.getTime();
		Long end=endTime.getTime();
			try {
				FileUtil.appendToFile("\n用时:"+(end-begin)+"毫秒"+"  "+msg, FileUtil.getFileSeparator()+fileName);
